...
parser = argparse.ArgumentParser(
    description='Predict depth for Tanks and Temples Intermediate set')

# --- Path and List Arguments ---
...
parser.add_argument('--testlist', default='lists/tnt/intermediate.txt', help='testing scene list')
